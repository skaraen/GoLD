...
func goliteparserParserInit() {
	...
	staticData.serializedATN = []int32{
		4, 1, 43, 375, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		74, 76, 78, 80, 82, 84, 86, 88, 90, 92, 0, 4, 1, 0, 19, 20, 2, 0, 21, 22,
		25, 26, 1, 0, 28, 29, 1, 0, 30, 31, 367, 0, 94, 1, 0, 0, 0, 2, 102, 1,
		...
		3, 1, 0, 0, 0, 104, 102, 1, 0, 0, 0, 105, 106, 5, 2, 0, 0, 106, 107, 5,
		42, 0, 0, 107, 108, 5, 7, 0, 0, 108, 109, 5, 34, 0, 0, 109, 110, 3, 6,
		3, 0, 110, 111, 5, 35, 0, 0, 111, 112, 5, 36, 0, 0, 112, 5, 1, 0, 0, 0,
		113, 117, 3, 8, 4, 0, 114, 116, 3, 8, 4, 0, 115, 114, 1, 0, 0, 0, 116,
		119, 1, 0, 0, 0, 117, 115, 1, 0, 0, 0, 117, 118, 1, 0, 0, 0, 118, 7, 1,
		0, 0, 0, 119, 117, 1, 0, 0, 0, 120, 121, 3, 10, 5, 0, 121, 122, 5, 36,
		0, 0, 122, 9, 1, 0, 0, 0, 123, 124, 5, 42, 0, 0, 124, 125, 3, 14, 7, 0,
		125, 11, 1, 0, 0, 0, 126, 127, 5, 30, 0, 0, 127, 128, 5, 42, 0, 0, 128,
		13, 1, 0, 0, 0, 129, 133, 5, 4, 0, 0, 130, 133, 5, 5, 0, 0, 131, 133, 3,
		...
		0, 0, 0, 139, 137, 1, 0, 0, 0, 140, 141, 5, 3, 0, 0, 141, 142, 3, 20, 10,
		0, 142, 143, 3, 14, 7, 0, 143, 144, 5, 36, 0, 0, 144, 19, 1, 0, 0, 0, 145,
		149, 5, 42, 0, 0, 146, 148, 3, 22, 11, 0, 147, 146, 1, 0, 0, 0, 148, 151,
		1, 0, 0, 0, 149, 147, 1, 0, 0, 0, 149, 150, 1, 0, 0, 0, 150, 21, 1, 0,
		0, 0, 151, 149, 1, 0, 0, 0, 152, 153, 5, 37, 0, 0, 153, 154, 5, 42, 0,
		0, 154, 23, 1, 0, 0, 0, 155, 157, 3, 26, 13, 0, 156, 155, 1, 0, 0, 0, 157,
		160, 1, 0, 0, 0, 158, 156, 1, 0, 0, 0, 158, 159, 1, 0, 0, 0, 159, 25, 1,
		0, 0, 0, 160, 158, 1, 0, 0, 0, 161, 162, 5, 6, 0, 0, 162, 163, 5, 42, 0,
		0, 163, 165, 3, 28, 14, 0, 164, 166, 3, 32, 16, 0, 165, 164, 1, 0, 0, 0,
		165, 166, 1, 0, 0, 0, 166, 167, 1, 0, 0, 0, 167, 168, 5, 34, 0, 0, 168,
		169, 3, 16, 8, 0, 169, 170, 3, 34, 17, 0, 170, 171, 5, 35, 0, 0, 171, 27,
		1, 0, 0, 0, 172, 180, 5, 32, 0, 0, 173, 177, 3, 10, 5, 0, 174, 176, 3,
		...
		183, 5, 33, 0, 0, 183, 29, 1, 0, 0, 0, 184, 185, 5, 37, 0, 0, 185, 186,
		...
		203, 202, 1, 0, 0, 0, 204, 37, 1, 0, 0, 0, 205, 206, 5, 34, 0, 0, 206,
		207, 3, 34, 17, 0, 207, 208, 5, 35, 0, 0, 208, 39, 1, 0, 0, 0, 209, 210,
		5, 8, 0, 0, 210, 211, 3, 64, 32, 0, 211, 212, 5, 36, 0, 0, 212, 41, 1,
		0, 0, 0, 213, 214, 5, 10, 0, 0, 214, 215, 3, 60, 30, 0, 215, 216, 5, 36,
		0, 0, 216, 43, 1, 0, 0, 0, 217, 218, 3, 60, 30, 0, 218, 219, 5, 27, 0,
		0, 219, 220, 3, 64, 32, 0, 220, 221, 5, 36, 0, 0, 221, 45, 1, 0, 0, 0,
		222, 223, 5, 9, 0, 0, 223, 224, 5, 32, 0, 0, 224, 228, 5, 40, 0, 0, 225,
		227, 3, 58, 29, 0, 226, 225, 1, 0, 0, 0, 227, 230, 1, 0, 0, 0, 228, 226,
		1, 0, 0, 0, 228, 229, 1, 0, 0, 0, 229, 231, 1, 0, 0, 0, 230, 228, 1, 0,
		0, 0, 231, 232, 5, 33, 0, 0, 232, 233, 5, 36, 0, 0, 233, 47, 1, 0, 0, 0,
		234, 235, 5, 11, 0, 0, 235, 236, 5, 32, 0, 0, 236, 237, 3, 64, 32, 0, 237,
		238, 5, 33, 0, 0, 238, 241, 3, 38, 19, 0, 239, 240, 5, 12, 0, 0, 240, 242,
		3, 38, 19, 0, 241, 239, 1, 0, 0, 0, 241, 242, 1, 0, 0, 0, 242, 49, 1, 0,
		0, 0, 243, 244, 5, 13, 0, 0, 244, 245, 5, 32, 0, 0, 245, 246, 3, 64, 32,
		0, 246, 247, 5, 33, 0, 0, 247, 248, 3, 38, 19, 0, 248, 51, 1, 0, 0, 0,
		249, 251, 5, 14, 0, 0, 250, 252, 3, 64, 32, 0, 251, 250, 1, 0, 0, 0, 251,
		252, 1, 0, 0, 0, 252, 253, 1, 0, 0, 0, 253, 254, 5, 36, 0, 0, 254, 53,
		1, 0, 0, 0, 255, 256, 5, 42, 0, 0, 256, 257, 3, 56, 28, 0, 257, 258, 5,
		36, 0, 0, 258, 55, 1, 0, 0, 0, 259, 267, 5, 32, 0, 0, 260, 264, 3, 64,
		...
		301, 302, 5, 24, 0, 0, 302, 303, 3, 74, 37, 0, 303, 71, 1, 0, 0, 0, 304,
		...
		87, 1, 0, 0, 0, 343, 341, 1, 0, 0, 0, 344, 345, 5, 39, 0, 0, 345, 350,
		3, 90, 45, 0, 346, 347, 5, 29, 0, 0, 347, 350, 3, 90, 45, 0, 348, 350,
		...
		5, 32, 0, 0, 359, 360, 3, 64, 32, 0, 360, 361, 5, 33, 0, 0, 361, 373, 1,
		0, 0, 0, 362, 364, 5, 42, 0, 0, 363, 365, 3, 56, 28, 0, 364, 363, 1, 0,
		0, 0, 364, 365, 1, 0, 0, 0, 365, 373, 1, 0, 0, 0, 366, 373, 5, 41, 0, 0,
		367, 368, 5, 15, 0, 0, 368, 373, 5, 42, 0, 0, 369, 373, 5, 16, 0, 0, 370,
		373, 5, 17, 0, 0, 371, 373, 5, 18, 0, 0, 372, 358, 1, 0, 0, 0, 372, 362,
...
const (
	...
	GoliteParserBOOL      = 5
	GoliteParserFUNC      = 6
	GoliteParserSTRUCT    = 7
	GoliteParserDELETE    = 8
	GoliteParserPRINTF    = 9
	GoliteParserSCAN      = 10
	GoliteParserIF        = 11
	GoliteParserELSE      = 12
	GoliteParserFOR       = 13
	...
	GoliteParserNIL       = 18
	GoliteParserEQUALS    = 19
	GoliteParserNEQUALS   = 20
	GoliteParserGTE       = 21
	GoliteParserLTE       = 22
	GoliteParserOR        = 23
	GoliteParserAND       = 24
	GoliteParserGT        = 25
	GoliteParserLT        = 26
	GoliteParserASSIGN    = 27
	GoliteParserPLUS      = 28
	GoliteParserMINUS     = 29
	GoliteParserASTERIX   = 30
	GoliteParserFSLASH    = 31
	GoliteParserLPAREN    = 32
	GoliteParserRPAREN    = 33
	GoliteParserLBRACE    = 34
	GoliteParserRBRACE    = 35
	GoliteParserSEMICOLON = 36
	GoliteParserCOMMA     = 37
	GoliteParserDOT       = 38
	GoliteParserNOT       = 39
	GoliteParserSTRING    = 40
	GoliteParserNUM       = 41
	GoliteParserID        = 42
	GoliteParserWS        = 43
)
...
func (p *GoliteParser) Function() (localctx IFunctionContext) {
	...
	if (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&1073741872) != 0 {
		{
			p.SetState(164)
			p.ReturnType()
		}
...
func (p *GoliteParser) Statements() (localctx IStatementsContext) {
	...
	for (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&4398046539520) != 0 {
		{
			p.SetState(189)
...
func (p *GoliteParser) Return_() (localctx IReturnContext) {
	...
	if (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&7151657910272) != 0 {
		{
			p.SetState(250)
			p.Expression()
		}
...
func (p *GoliteParser) RelTermPrime() (localctx IRelTermPrimeContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&106954752) != 0) {
			var _ri = p.GetErrorHandler().RecoverInline(p)
...
func (p *GoliteParser) RelTerm() (localctx IRelTermContext) {
	...
	for (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&106954752) != 0 {
		{
			p.SetState(318)
			p.RelTermPrime()
		}
